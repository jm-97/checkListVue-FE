...
let activitiesPreReleases = ["Sviluppo lato policy Studio per accogliere le nuove modifiche seguendo l’ATE.",
  "SIT",
  "UAT",
  "No regression in qa",
...
let activitiesDuringReleases = ["Deployare real security feature/PJ003316 da gandalf in prod",
...
let activitiesPostReleases = ["merge feature branch to master di real security",
...
let stati = [{ value: "non_completato", color: "red" }, { value: "non_necessario", color: "brown" }, { value: "ongoing", color: "blue" }, { value: "completato", color: "green" }]
