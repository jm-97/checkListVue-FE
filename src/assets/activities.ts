      ...
      "fases": [
        {
          ...
          "activity": [
            ...
            {
              "text": "Caricamento swagger .docs h.0.30 su API Portal joomla per le 4 macchine",
              "stato": "non_completato"
            },
            {
            ...
            {
              "text": "Caricamento yaml countrySpecific h.0.30 su API Portal",
              "stato": "non_completato"
            },
            {
        ...
        },
        {
          ...
          "activity": [
            {
              "text": "Deployare real security feature/PJ002835 da gandalf in prod",
              "stato": "non_completato"
            },
            {
            ...
            {
              "text": "Aggiornamento API Manager APIM CLI, con swagger h.0.30\n",
              "stato": "non_completato"
            },
            {
      ...
      "fases": [
        {
          ...
          "activity": [
            ...
            {
              "text": "Caricamento swagger .docs h.0.28 su API Portal joomla per le 4 macchine",
              "stato": "non_completato"
            },
            {
              "text": "Aprire task per update dns",
            ...
            {
              "text": "Caricamento yaml countrySpecific h.0.28 su API Portal",
              "stato": "non_completato"
            },
            {
              "text": "Verificare su tutte le macchine",
